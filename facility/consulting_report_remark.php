<?php
	...
	*/
    ...
    $query_not_entered="SELECT * FROM patient pa,protocol pr,visit v WHERE pa.patient_ID=v.patient_ID AND pr.visit_ID=v.visit_ID AND v.visit_ID NOT IN (SELECT visit_ID FROM diagnosis_ids,protocol WHERE protocol.protocol_ID=diagnosis_ids.protocol_ID) AND checkin_time BETWEEN '$from' AND '$to 23:59:59' AND onlylab=0 GROUP BY v.visit_ID";
