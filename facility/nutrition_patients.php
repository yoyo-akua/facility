<?php
	...
	*/
	$query="SELECT * FROM patient,visit,protocol,nutrition WHERE patient.patient_ID=visit.patient_ID AND visit.visit_ID=protocol.visit_ID AND nutrition.protocol_ID=protocol.protocol_ID AND checkout_time like '0000-00-00 00:00:00' AND onlylab=0 AND protocol.timestamp>(DATE_SUB('2022-08-18',INTERVAL 1 YEAR)) ORDER BY checkin_time ASC ";
